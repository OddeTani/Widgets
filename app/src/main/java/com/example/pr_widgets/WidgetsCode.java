package com.example.pr_widgets;
...
public class WidgetsCode extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        views = new RemoteViews(context.getPackageName(), R.layout.widget_xml);
        componentName = new ComponentName(context, WidgetsCode.class);
    ...
    private class JokeLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids){
            ...
            try{
                ...
                WidgetsCode.futureJokeString = jsonObject.getString("value");
            }
